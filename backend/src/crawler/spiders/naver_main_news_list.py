...
from src.crawler.constant import KST, NaverArticleCategoryEnum
from src.crawler.items import NaverArticleItem
...
class BaseNaverSectionNewsSpider(BaseNaverNewsSpider):
    ...
    def _extract_dl_tags(self, soup: BeautifulSoup) -> list:
        ...
        return [dl for li in li_tags_top for dl in li.find_all("dl")] # type: ignore
